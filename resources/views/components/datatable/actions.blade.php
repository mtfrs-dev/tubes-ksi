<div class="flex gap-2 items-center">
    ...
    <button id="update_btn_{{ $value }}" type="button" class="rounded py-1 px-2 text-xs text-white bg-primary hover:bg-primary-70 w-fit" wire:click="showUpdateModal({{ $value }})">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
